...
namespace FragmentTags
{
	...
	namespace StatMod
	{
		UE_DEFINE_GAMEPLAY_TAG_COMMENT(StatMod_1, "FragmentTags.StatMod.1", "StatMod.1");
		UE_DEFINE_GAMEPLAY_TAG_COMMENT(StatMod_2, "FragmentTags.StatMod.2", "StatMod.2");
		UE_DEFINE_GAMEPLAY_TAG_COMMENT(StatMod_3, "FragmentTags.StatMod.3", "StatMod.3");
	}
}