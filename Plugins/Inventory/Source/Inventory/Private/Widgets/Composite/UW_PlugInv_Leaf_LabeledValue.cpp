...
void UPlugInv_Leaf_LabeledValue::SetText_Label(const FText& Text, bool bCollapse) const
{
	if (bCollapse)
	{
...
void UPlugInv_Leaf_LabeledValue::SetText_Value(const FText& Text, bool bCollapse) const
{
	if (bCollapse)
	{
...
void UPlugInv_Leaf_LabeledValue::NativePreConstruct()
{
